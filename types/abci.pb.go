...
type OpResponse struct {
	...
	Height int64 `protobuf:"varint,1,opt,name=height,proto3" json:"height,omitempty"`
	// The transaction hash.
	OpHash string `protobuf:"bytes,2,opt,name=ophash,proto3" json:"ophash,omitempty"`
	// Namespace for the Code
	Codespace string `protobuf:"bytes,3,opt,name=codespace,proto3" json:"codespace,omitempty"`
	// Response code.
	Code uint32 `protobuf:"varint,4,opt,name=code,proto3" json:"code,omitempty"`
	...
	// The request transaction bytes.
	Op *types.Any `protobuf:"bytes,6,opt,name=op,proto3" json:"op,omitempty"`
	// Time of the previous block. For heights > 1, it's the weighted median of
	// the timestamps of the valid votes in the block.LastCommit. For height == 1,
	// it's genesis time.
...
func init() {
	...
	proto.RegisterType((*OpResponse)(nil), "cosmos.base.abci.v1beta1.OpResponse")
}
...
var fileDescriptor_4e37629bc7eb0df8 = []byte{
	...
	,
}
...
func (m *OpResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.Ret) > 0 {
		i -= len(m.Ret)
		copy(dAtA[i:], m.Ret)
		i = encodeVarintAbci(dAtA, i, uint64(len(m.Ret)))
		i--
		dAtA[i] = 0x2a
	}
	if m.Code != 0 {
	...
	if len(m.OpHash) > 0 {
		i -= len(m.OpHash)
		copy(dAtA[i:], m.OpHash)
		i = encodeVarintAbci(dAtA, i, uint64(len(m.OpHash)))
		i--
		dAtA[i] = 0x12
	}
	if m.Height != 0 {
...
func (m *OpResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.OpHash = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Codespace", wireType)
